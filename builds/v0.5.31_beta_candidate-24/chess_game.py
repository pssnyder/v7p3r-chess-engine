...
class ChessGame:
    def __init__(self):
        ...
        self.show_thoughts = self.config['ai']['show_thinking']
    ...
    def ai_move(self):
        ...
        # Use the AI to select a move
        best_move, best_score = self.ai_player.select_move(self.board)
        ...
        return best_move.uci() if best_move else self.ai_player.select_fallback()
