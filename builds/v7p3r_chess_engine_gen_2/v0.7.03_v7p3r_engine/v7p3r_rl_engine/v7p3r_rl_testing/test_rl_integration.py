...
def test_rl_integration():
    ...
    try:
        ...
        if 'v7p3r_rl' in game.engines:
            print("   Γ£ô RL engine successfully loaded")
        else:
            print("   Γ£ù RL engine not available")
            return False
        ...
        print("Γ£ô RL engine integration test passed!")
        return True
        
    except Exception as e:
        print(f"Γ£ù Integration test failed: {e}")
        import traceback
        traceback.print_exc()
        return False
...
def test_engine_vs_stockfish():
    ...
    try:
        ...
        game.cleanup_engines()
        print("Γ£ô RL vs Stockfish test passed!")
        return True
        
    except Exception as e:
        print(f"Γ£ù RL vs Stockfish test failed: {e}")
        return False
