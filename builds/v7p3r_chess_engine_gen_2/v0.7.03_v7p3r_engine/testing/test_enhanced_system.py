...
if __name__ == "__main__":
    ...
    try:
        ...
        if hasattr(game, 'use_enhanced_metrics') and game.use_enhanced_metrics:
            print("Γ£ô Enhanced metrics system is active!")
            print("Γ£ô Detailed scoring breakdown will be collected")
            print("Γ£ô Engine-specific attribution enabled")
            print("Γ£ô Position analysis included")
        else:
            print("ΓÜá Using legacy metrics system")
        
        print(f"Γ£ô Testing with: {game.white_player} vs {game.black_player}")
        print("Γ£ô Starting test game...")
        print()
        ...
        print("\nΓ£ô Enhanced metrics system test completed successfully!")
