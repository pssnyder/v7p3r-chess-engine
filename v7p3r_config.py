...
class v7p3rConfig:
    ...
    def _load_ruleset(self):
        ...
        The default ruleset is stored in 'configs/rulesets/default_ruleset.json'.
        """
        ruleset_path = os.path.join(os.path.dirname(__file__), 'configs', 'rulesets', f"custom_rulesets.json")
        try:
