...
MAX_FPS = 60
from v7p3r_engine.v7p3r_engine import v7p3rEngine # Corrected import for v7p3rEngine
...
class ChessGame:
    ...
    def _initialize_ai_engines(self):
        ...
        if self.white_engine_config.get('engine', '').lower() == 'v7p3r':
            ...
            self.white_engine = v7p3rEngine(self.board, chess.WHITE)
        ...
        if self.black_engine_config.get('engine', '').lower() == 'v7p3r':
            ...
            self.black_engine = v7p3rEngine(self.board, chess.BLACK)
    ...
    def process_ai_move(self):
        ...
        if isinstance(current_ai_engine, v7p3rEngine): # Changed from EvaluationEngine
