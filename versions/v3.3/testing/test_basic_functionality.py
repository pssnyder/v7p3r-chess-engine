...
def test_engine_initialization():
    ...
    try:
        ...
        print(f"Γ£ô Engine initialized: {info['name']} v{info['version']}")
        ...
        print(f"Γ£ù Engine initialization failed: {e}")
        return False
...
def test_move_generation():
    ...
    try:
        ...
        if move and move in board.legal_moves:
            print(f"Γ£ô Generated legal move: {move}")
            ...
            print(f"Γ£ù Invalid move generated: {move}")
            return False
            
    except Exception as e:
        print(f"Γ£ù Move generation failed: {e}")
        return False
...
def test_stockfish_integration():
    ...
    try:
        ...
        if stockfish.is_available():
            ...
            if move and move in board.legal_moves:
                print(f"Γ£ô Stockfish generated legal move: {move}")
                ...
                print(f"Γ£ù Stockfish generated invalid move: {move}")
                return False
        else:
            print("Γ£ù Stockfish not available")
            return False
            
    except Exception as e:
        print(f"Γ£ù Stockfish integration failed: {e}")
        return False
...
def test_performance():
    ...
    try:
        ...
        if moves_tested > 0:
            ...
            print(f"Γ£ô Performance test completed")
            ...
            if avg_time < 30.0 and max_time < 30.0:
                print("Γ£ô Performance meets requirements (< 30s per move)")
                return True
            else:
                print("ΓÜá Performance may not meet requirements")
                return False
        else:
            print("Γ£ù No moves generated for performance test")
            return False
            
    except Exception as e:
        print(f"Γ£ù Performance test failed: {e}")
        return False
...
def test_game_completion():
    ...
    try:
        ...
        if not stockfish.is_available():
            print("ΓÜá Stockfish not available for game test")
            return True
        ...
        while not board.is_game_over() and moves_played < max_moves:
            ...
            if move and move in board.legal_moves:
                ...
                print(f"Γ£ù Invalid move from {player}: {move}")
                return False
        
        print(f"Γ£ô Game test completed ({moves_played} moves)")
        return True
        
    except Exception as e:
        print(f"Γ£ù Game completion test failed: {e}")
        return False
...
def main():
    ...
    if passed == total:
        print("Γ£ô All tests passed! Engine is ready.")
        return 0
    else:
        print("ΓÜá Some tests failed. Check the output above.")
        return 1
