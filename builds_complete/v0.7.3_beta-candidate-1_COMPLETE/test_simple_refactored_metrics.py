...
def test_simple_refactored_metrics():
    ...
    try:
        ...
        print(f"Γ£ô Engine initialized: {engine.name}")
        print(f"Γ£ô Refactored collector initialized")
        print(f"Γ£ô Enhanced metrics store initialized")
            ...
            try:
                ...
                if best_move in board.legal_moves:
                    ...
                    try:
                        ...
                        print(f"Γ£ô Metrics stored for move {move_num}")
                        ...
                        print(f"Γ£ù Failed to store metrics: {e}")
                        
                else:
                    print(f"Γ£ù Illegal move selected: {best_move}")
                    break
                    
            except Exception as e:
                print(f"Γ£ù Search failed: {e}")
                break
        ...
        print(f"Γ£ô Game finished and recorded as: {result}")
        ...
        print(f"\nΓ£ô Test completed successfully!")
...
def test_dataset_integration():
    ...
    try:
        ...
        print(f"Γ£ô Dataset integration test completed")
