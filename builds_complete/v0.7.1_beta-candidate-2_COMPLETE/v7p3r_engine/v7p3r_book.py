...
log_filename = f"v7p3r_book_{timestamp}.log"
log_file_path = os.path.join(log_dir, log_filename)

v7p3r_book_logger = logging.getLogger(f"v7p3r_book_{timestamp}")
v7p3r_book_logger.setLevel(logging.DEBUG)

if not v7p3r_book_logger.handlers:
    ...
    v7p3r_book_logger.addHandler(file_handler)
    v7p3r_book_logger.propagate = False
