...
class EvaluationEngine:
    ...
    # Rule: IF both Knights are still in play THEN add 1 point to each Knight pieceΓÇÖs value FOR having a Knight pair.
    ...
    # Rule: IF a Bishop controls more than 3 squares THEN add 1 point to that BishopΓÇÖs piece value FOR having good board coverage.
    ...
    # Rule: IF a pawn has no opposing pawns in either of its adjacent files THEN add 1 point to that pawnΓÇÖs piece value FOR it being a passed pawn.
