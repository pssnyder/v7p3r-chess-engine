#!/usr/bin/env python3
"""
V7P3R Chess Engine v17.6 - Pawn Structure Intelligence (Phase 1)

Based on 52-game v17.5 analytics showing 159 isolated pawns/game, v17.6 adds
lightweight pawn structure awareness to the fast evaluator without sacrificing speed.
