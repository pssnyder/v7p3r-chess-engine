#!/usr/bin/env python3
"""
V7P3R v8.1 UCI Interface
Simplified UCI interface with deterministic evaluation
"""
    ...
    while True:
        try:
            ...
            if command == "quit":
                ...
                board = chess.Board()
                engine.new_game()
                print("info string New game started - deterministic evaluation")
