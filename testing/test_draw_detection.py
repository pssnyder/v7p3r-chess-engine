...
def test_threefold_repetition():
    ...
    if board.can_claim_threefold_repetition() and game._is_game_over():
        print("✓ SUCCESS: Threefold repetition detected correctly!")
        return True
    else:
...
if __name__ == "__main__":
    ...
    if test1_pass and test2_pass:
        print("✓ ALL TESTS PASSED - Draw detection working correctly!")
    else:
        print("✗ SOME TESTS FAILED - Draw detection needs adjustment")
