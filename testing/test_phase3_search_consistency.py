    ...
    def test_search_algorithm_consistency(self):
        ...
        for algorithm in algorithms:
            ...
            try:
                ...
                print(f"❌ Algorithm '{algorithm}' failed with error: {e}")
                return False
...
def run_phase3_tests():
    ...
    try:
        ...
        print("✓ Minimax evaluation perspective test PASSED")
        
        test_instance.test_negamax_evaluation_perspective()
        print("✓ Negamax evaluation perspective test PASSED")
        
        test_instance.test_quiescence_evaluation_perspective()
        print("✓ Quiescence evaluation perspective test PASSED")
        
        test_instance.test_search_algorithm_consistency()
        print("✓ Search algorithm consistency test PASSED")
        
        test_instance.test_evaluation_sign_consistency()
        print("✓ Evaluation sign consistency test PASSED")
