...
def test_search_issues():
    ...
    print("   ❌ PROBLEM: Uses board.turn instead of maintaining root player perspective")
    ...
    print("   eval_result = self.scoring_calculator.evaluate_position_from_perspective(board, board.turn)")
    print("   ❌ PROBLEM: Same issue - uses board.turn instead of root perspective")
    ...
    print("   ❌ PROBLEM: Same issue - evaluation perspective changes with board.turn")
    ...
    print("   ❌ PROBLEM: Inconsistent perspective tracking")
    ...
    print("   ❌ PROBLEM: Mixed evaluation timing and perspective")
    
    print("\n=== CONSEQUENCES ===")
    print("These bugs cause:")
    print("• Engine evaluates positions from wrong perspective")
    print("• Search tree score propagation is inconsistent")
    print("• Engine may choose moves that are bad for it")
    print("• Evaluation numbers become meaningless")
    print("• Engine playing strength significantly reduced")
