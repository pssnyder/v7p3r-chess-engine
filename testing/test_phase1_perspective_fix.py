...
def test_perspective_evaluation_fix():
    ...
    if abs(white_perspective - stored_evaluation) < 0.001:
        print("✅ SUCCESS: Stored evaluation matches perspective evaluation")
        return True
    else:
        print("❌ FAILURE: Stored evaluation does not match perspective evaluation")
        return False
...
def test_position_with_advantage():
    ...
    if white_perspective > 500 and abs(white_perspective - stored_evaluation) < 0.001:
        print("✅ SUCCESS: White shows large positive advantage and storage is correct")
        return True
    else:
        print("❌ FAILURE: Either advantage not detected or storage mismatch")
        return False
...
if __name__ == "__main__":
    ...
    try:
        ...
        if test1_result and test2_result:
            print("✅ Phase 1 fix appears to be working correctly!")
        else:
            print("❌ Phase 1 fix needs further investigation")
