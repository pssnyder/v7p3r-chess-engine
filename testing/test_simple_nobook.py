...
logger = v7p3rLogger.setup_logger("test_simple_nobook")

def test_simple_search_without_opening_book():
    # Load the configuration with "simple" as the search algorithm and opening book disabled
    config_manager = v7p3rConfig(config_path=os.path.join('configs', 'test_simple_config.json'))
...
if __name__ == "__main__":
    test_simple_search_without_opening_book()
