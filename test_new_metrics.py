...
async def test_metrics_system():
    ...
    print("🎯 Testing V7P3R Unified Metrics System")
    print("=" * 50)
    ...
    print(f"✅ Game recording: {'Success' if success else 'Failed'}")
    ...
    print(f"✅ Move recording: {'Success' if success else 'Failed'}")
    ...
    print(f"✅ Game completion: {'Success' if success else 'Failed'}")
    ...
    print(f"✅ Engine config recording: {'Success' if success else 'Failed'}")
    
    # Test data retrieval
    game_summary = await metrics.get_game_summary(game_id)
    print(f"✅ Game summary retrieval: {'Success' if game_summary else 'Failed'}")
    if game_summary:
    ...
    print(f"✅ Performance trends: {'Success' if not trends_df.empty else 'No data'}")
    ...
    print("✅ Legacy game recording compatibility")
    ...
    print("✅ Legacy move recording compatibility")
    
    print("\n🎉 All tests completed successfully!")
    print("📊 The new metrics system is ready for integration with v7p3r_play.py")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("💡 To run the Streamlit dashboard: python metrics/chess_metrics.py dashboard")
    else:
        print("\n❌ Test failed!")
        sys.exit(1)
